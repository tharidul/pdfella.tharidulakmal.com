...
export function MergeActionBar({ fileCount, onMerge, isMerging = false }: MergeActionBarProps) {
  ...
  return (
    <div className="w-full rounded-2xl p-4 bg-brand-subtle border border-brand-border flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mt-5 shadow-2xs">
      <div className="flex items-center gap-3.5">
        <div className="w-7 h-7 rounded-full bg-brand-primary text-white flex items-center justify-center shrink-0 shadow-2xs">
