    ...
    >
      <div className="w-full flex items-center justify-between mb-2">
        ...
        <button
          ...
          className={`min-w-[32px] min-h-[32px] flex items-center justify-center p-1.5 rounded-lg transition-colors ${
            totalCount <= 1
              ? "text-neutral-200 cursor-not-allowed"
              : "text-neutral-500 hover:text-brand-primary hover:bg-brand-subtle cursor-pointer"
          }`}
        >
      ...
      <div className="w-full flex items-center justify-between mt-3 pt-2 border-t border-neutral-100">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="min-w-[32px] min-h-[32px] flex items-center justify-center p-1.5 rounded-lg hover:bg-neutral-100 text-neutral-700 transition-colors cursor-pointer"
          >
